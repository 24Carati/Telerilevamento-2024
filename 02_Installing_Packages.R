# installazione di un nuovo pacchetto su R
# PACCHETTI PRESENTI
# Pacchetto terra
# Pacchetto devtools
# Pacchetto imageRy
...
# se quando faccio questo lavoro mi chiede da quale città, devo scegliene una a caso.
...
# installa il pacchetto imageRy da GitHub: install_github, serve aver installato devtools che è sul CRAN
# una funzione di devtools: va nel github di qualcuno e vede se c'è la funzione
